          ...
          tabBarIcon: ({ color, size, focused }) => {
            ...
            return (
              ...
              >
                {focused && (
                  <View
                    style={{
                      ...
                      backgroundColor: '#980404', // Change the color of the line
                      marginBottom: 12, // Add margin to separate the line from the icon
                    }}
                  />
                )}
                <Animated.View
                ...
                >
                  <FontAwesome5
                    name="user-tie" // Your FontAwesome5 component
                    size={18}
                    color={color}
                  />
                </Animated.View>
    ...
    if (firstName && lastName) {
      ...
      AsyncStorage.removeItem('userData')
        .then(() => {
          ...
          setFirstName('');
          setLastName('');
          setUserData(null); // Update the state to reflect user logout
          // Other logout actions, such as navigating to the login screen
      ...
      <View style={{}}>
        <View style={{ padding: 20, }}>
          ...
          <Image
           ...
           {userData ? `${userData.firstName} ${userData.lastName}` : 'User Login'}
              </Text>
            </View>
