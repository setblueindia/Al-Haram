        ...
        <View style={[
            ...
            >
                <FastImage
                    ...
                    source={{ uri: BASE_URL + items?.mobile_image }}
                />
            ...
            <View
                ...
                <TouchableOpacity
                    ...
                    {items?.display_mode == "PAGE" && <Text style={[styles.viewText, lang.data == NUMBER.num0 && { textAlign: EXTRASTR.left }]}>{lable.ViewAll}</Text>}
                </TouchableOpacity>
            </View>
                            ...
                            <>
                                {sitems?.include_in_menu == 1 &&
                                    <TouchableOpacity
                                        ...
                                        style={{ justifyContent: ALINE.center, alignItems: ALINE.center }} >
                                        {
                                            RoundImage &&
                                            <View style={styles.innerCategoriesView}>
                                                <FastImage
                                                    style={styles.storyView}
                                                    source={{ uri: RoundImage }}
                                                />
                                            </View>
                                        }
                                        <Text
