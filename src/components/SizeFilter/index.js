                ...
                <View style={[
                    ...
                    <View style={[
                        ...
                        <Text
                            ...
                            {lang == NUMBER.num1 ? "Filter By" : "تصنيف"}
                        </Text>
                    </View>
                    ...
                    >
                        ...
                        <TouchableOpacity
                            onPress={() => {
                                setProductData(fdata), setSizeFilter(false)
                            }}
                            style={[
                                styles.ApplyView,
                                lang == NUMBER.num0 && {
