    ...
    const categoris = [
        {
            ...
            img: require('../../assets/images/Home/img1.png')
        },
        {
            name: lang?.data == NUMBER.num1 ? "Football" : "كرة القدم",
            img: require('../../assets/images/Home/img2.png')
        },
        {

            name: lang?.data == NUMBER.num1 ? "Football" : "كرة القدم",
            img: require('../../assets/images/Home/img3.png')
        },
        {

            name: lang?.data == NUMBER.num1 ? "Football" : "كرة القدم",
            img: require('../../assets/images/Home/img4.png')
        },
        {
