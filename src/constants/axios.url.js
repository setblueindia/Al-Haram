...
export const OTPVerification = BASE_URL + "/rest/arabic/V1/api/mobileOtpVerifyCreateMethod"
export const HOMEURL = BASE_URL + "/rest/V1/api/getHomeSliderMethod"
export const UpdateProfileURL = BASE_URL + "/rest/V1/api/customerProfileUpdateMethod"
export const AddRemoveToWhishLisstURL = BASE_URL + "/rest/V1/api/addWishlistMethod"
export const WhishListURL = BASE_URL + "/rest/V1/api/getWishlistCollectionMethod"
