export const Ar = {
  ...
  GiftCardAccountBalanceCheck: "التحقق من رصيد حساب بطاقة الهدايا",
  EnterYourCode: "رمز البطاقة",
  CheckBalance: "التحقق من الرصيد",
  Code: "رمز البطاقة : ",
  CurrentBalance: "الرصيد الحالي",
  Usage: "الاستخدام",
  ValidTill: "صالحة حتى ",
  SocialLinks: "حساباتنا",
  ...
  Color: "اللون",
  Bethefirsttoreviewthisproduct: "قيمة البطاقة بالريال السعودي",
  CardValueinSAR: "قيمة البطاقة بالريال السعودي",
  Otheramount: "مبلغ آخر",
  Recipientmyself: "أنا المستلم",
  YourName: "الاسم",
  EnterSenderName: "أدخل اسم المرسل",
  RecipientName: "اسم المستلم",
  EnterRecipientName: "أدخل اسم المستلم",
  RecipientEmail: "البريد الإلكتروني للمستلم",
  EnterRecipientEmailoptional: "عنوان البريد الإلكتروني - اختياري",
  RecipientMobileNumber: "هاتف المستلم",
  EnterRecipientMobileNumber: "رقم جوال المستلم",
  Message: "رسالة",
  Entermessageoptional: "أدخل رسالتك - اختياري",
  AddNewRecipient: "إضافة مستلم جديد",
...
export const En = {
  ...
  Entermessageoptional: "Enter message - optional",
  AddNewRecipient: "+ Add New Recipient",
  EnterRecipientEmailoptional: "Enter Recipient Email - optional",
  Message: "Message",
  Scheduledelivery: "Schedule delivery",
  EnterRecipientMobileNumber: "Enter Recipient Mobile Number",
  ...
  GiftCardAccountBalanceCheck: "Gift Card Account Balance Check",
  Bethefirsttoreviewthisproduct: "Be the first to review this product",
  CardValueinSAR: "Card Value in SAR",
  ...
  Recipientmyself: "Recipient my self",
  Usage: "Usage",
  Color: "Color",
  Code: "Code",
  Sort: "Sort",
