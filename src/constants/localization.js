export const Ar = {
  ...
  Invalidpassword: "الرجاء إدخال رمز مكوّن من 8 خانات على الأقل، ويحتوي على الأقل على: رقم واحد، حرف كبير واحد، حرف صغير واحد، ورمز خاص واحد",
  ...
  Send: "أرسل",
  forgetDes: "الرجاء إدخال عنوان بريدك الإلكتروني وسنرسل لك رابط إعادة كلمة المرور",
  ...
  SAR: "ر.س",
  PaymentByYourWallet: " الدفع بالمحفظة",
  ...
  CameraPermission: "إذن استخدام الكاميرا",
  CameraaccessisrequiredtoscanbarcodesPleaseenableitfromsettings: "يطلب التطبيق إذن الوصول إلى الكاميرا لمسح رمز الباركود . يُرجى تفعيل الإذن من الإعدادات.",
  Howtoenablecameraaccess: " كيفية تفعيل إذن الكاميرا",
  AndroidAccessStep: "لأجهزة Android: اذهب إلى  الإعدادات ➜ التطبيقات ➜ الهرم ➜ الأذونات ➜ تفعيل الكاميرا.",
  IosStep: " لأجهزة iOS: اذهب إلى الإعدادات ➜ الخصوصية ➜ الكاميرا ➜ فعّل الوصول لتطبيق الهرم.",
  OpenSettings: "فتح الإعدادات ",
  Thisappneedsaccesstoyourcameratoscanbarcodes: " يحتاج هذا التطبيق إلى إذن استخدام الكاميرا لمسح رمز  الباركود",
  OK: "نعم",
  Paymentbygiftcardorvoucher: "الدفع ببطاقة الهدية او القسيمة الشرائية",
  Remove: "إزالة",
  Enterthegiftcardnumberorscanthevouchercode: "أدخل رقم بطاقة الهدية او امسح رمز القسيمة الشرائية",
  CheckStatus: "تحقق",
  APPLY: "تطبيق"
...
export const En = {
  ...
  Enterthegiftcardnumberorscanthevouchercode: "Enter the gift card number or scan the voucher code",
  Howtoenablecameraaccess: "How to enable camera access:",
  Paymentbygiftcardorvoucher: "Payment by gift card or voucher",
  OK: "OK",
  Remove: "Remove",
  Thisappneedsaccesstoyourcameratoscanbarcodes: "This app needs access to your camera to scan barcodes",
  AndroidAccessStep: "📱 Android: Go to Settings ➜ Apps ➜ AlHaram ➜ Permissions ➜ Allow Camera.",
  IosStep: "📱 iOS: Go to Settings ➜ Privacy ➜ Camera ➜ Enable access for AlHaram.",
  hello: 'Hello',
  OpenSettings: "Open Settings",
  CameraPermission: "Camera Permission",
  CameraaccessisrequiredtoscanbarcodesPleaseenableitfromsettings: "Camera access is required to scan barcodes. Please enable it from settings.",
  Home: 'Home',
  Category: 'Category',
  ...
  Invalidpassword: "Please enter a password with at least 8 characters, including at least one number, one capital letter, one small letter, and one special character",
  ...
  SAR: "SAR",
  PaymentByYourWallet: "Payment By Wallet",
  ...
  EnterCoupanCode: "Enter Discount code",
  Tel: "Tel",
  vat: "vat",
  cr: "cr",
  color: "color :",
