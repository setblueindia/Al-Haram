            ...
            {row.map((items, index) => {
              ...
              return (
                <TouchableOpacity
                  key={actualIndex}
                  style={[
                    styles.firstCeteImageView,
                    (topIndex == actualIndex && on) && {
                  ...
                  <View>
                    <TouchableOpacity
                      ...
                      <View style={styles.subImageView}>
                        ...
                        <FastImage
                          source={subItem?.mobile_circle_thumbnail ? { uri: BASE_URL + subItem?.mobile_circle_thumbnail } : A}
                          style={[styles.subImge, !subItem?.mobile_thumbnail && { resizeMode: RESIZEMODE.contain }]}
                        />
                      </View>
